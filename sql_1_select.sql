...
SELECT Name City WHERE COUNTRYcode = 'Bfa';
#
# 5: Get both the name and district of the cities where the countrycode is "tto"
SELECT Name, District FROM CITY Where CountryCode = 'Tto';
#
# 6: Get the name and district named as nm,dist from the cities where the countrycode is "arm"
SELECT Name AS nm, Disstrict As dist FROM City WHERE CountryCode = 'Arm';
#
...
SELECT * FROM Country WHERE SurfaceAre < 10 AND LIfeExpectancy IS NOt NULL;
